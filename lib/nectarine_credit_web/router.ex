defmodule NectarineCreditWeb.Router do
  use NectarineCreditWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {NectarineCreditWeb.Layouts, :root}
  ...
  if Application.compile_env(:nectarine_credit, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: NectarineCreditWeb.Telemetry
